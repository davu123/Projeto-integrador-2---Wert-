...
export default function LotsPage() {
  ...
  async function handleSubmit(e) {
    ...
    const payload = {
      ...
      status: editandoId ? form.status : 'pendente',
    };
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <p style={{ margin: '0 0 24px', color: '#64748b' }}>
        Cadastre lotes ligados a uma agência e a um técnico. O ciclo de status é pendente, em triagem ou concluído.
      </p>
                  ...
                  <tr key={lote.id}>
                    ...
                    <td style={tdStyle}>
                      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                        ...
                        <button onClick={() => alterarStatus(lote.id, 'pendente')} style={secondaryButtonStyle}>Pendente</button>
                        <button onClick={() => alterarStatus(lote.id, 'em_triagem')} style={secondaryButtonStyle}>Em triagem</button>
